...
type UserResourceMappingService struct {
	...
	FindDeepMappingsF func(context.Context, platform.DeepUserResourceMappingFilter) ([]*platform.UserResourceMapping, int, error)
...
func (s *UserResourceMappingService) FindDeepUserResourceMappings(ctx context.Context, filter platform.DeepUserResourceMappingFilter) ([]*platform.UserResourceMapping, int, error) {
	return s.FindDeepMappingsF(ctx, filter)
}
